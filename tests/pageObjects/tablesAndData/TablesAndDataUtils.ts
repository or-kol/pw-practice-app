...
export class TablesAndDataUtils extends BasePage {
    ...
    validateSort(data: SmartTableRowData[] | TreeGridRowData[], columnKey: keyof SmartTableRowData | keyof TreeGridRowData, 
        sortOrder: 'ascending' | 'descending'): boolean {
